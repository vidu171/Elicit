    ...
    v.prototype.generateUUID = function() {
        ...
        s.getAttribute("data-url") && ("none" == c ? (h.push(s), function(i, s) {
            ...
            if (c = "loading", !r || g(i, r.version) > 0 || s(r, c = "loaded")) {
                ...
                l.type = "text/javascript", l.src = "//d1id5eheivyv24.cloudfront.net/2018-5-15-e6558acf8a40bc64/js/libs/popcorn.min.js", 
...
"undefined" == typeof RM && (RM = {}), function(t) {
    ...
    t.classes.embedplugins = t.classes.embedplugins || {}, t.embedutils = t.embedutils || {}, t.embedutils.findPlugin = function(e) {
        ...
        draw: function(t, e, i) {
            ...
            if (!this.isInViewer || this.block && this.block.model.get("use_iframe") || this.widget && this.widget.use_iframe) {
                a.each(function() {
                    s += this.outerHTML;
                }), s += '<script src="//d1id5eheivyv24.cloudfront.net/2018-5-15-e6558acf8a40bc64/js/vendor/jquery-2.2.3.min.js"><\/script>', 
    ...
    var i = Backbone.View.extend({
        ...
        defaultCover: "//d1id5eheivyv24.cloudfront.net/2018-5-15-e6558acf8a40bc64/img/common/audio-player/cover.png",
        initialize: function(e, i, s, n) {
...
window.onYouTubeIframeAPIReady = function() {
    ...
    t.classes.MagPassword = Backbone.View.extend({
        ...
        render: function(e) {
            ...
            }).prop("src", "//d1id5eheivyv24.cloudfront.net/2018-5-15-e6558acf8a40bc64/img/viewer/mag-password/bg.jpg");
        },
